...
//		System.out.println(Queries);
		...
		Settings settings = Settings.settingsBuilder().put("client.transport.sniff", true)
         ...
         BufferedReader br = new BufferedReader(new FileReader(QueryFile));  
		    ...
		    PrintWriter writer = new PrintWriter("okapi_TF_A2.txt", "UTF-8");
		    
		    while ((FullQueryTemp = br.readLine()) != null)  

		    {  
//for each query
		    	FullQueryTemp = FullQueryTemp.toLowerCase();
...
//operation on each word in query for every doc
				            ...
				            //   System.out.println(OkapiTFWD);
				             //  OkapiTFD = OkapiTFD + OkapiTFWD;
				               okapiTFMAP.put(DocID, 
				            		   okapiTFMAP.get(DocID) == null? OkapiTFWD : okapiTFMAP.get(DocID) + OkapiTFWD);	
